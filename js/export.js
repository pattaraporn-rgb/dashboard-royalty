...
.export-banner{display:flex!important;align-items:center;justify-content:center;gap:6px;background:#0A0A1A;border-top:1px solid #222;padding:12px 28px;font-size:12px;color:#888;font-weight:600;letter-spacing:.2px;text-align:center;}
...
<div class="card">
  ...
  <div id="p3_content" style="display:none"><div class="kpi-summary" id="kpi3"></div><div class="chart-hint"><i data-lucide="info"></i> คลิกชื่อช่องทาง = โฟกัสเฉพาะอันนั้น • ⌘+คลิก (Mac) หรือ Ctrl+คลิก (Windows) = เพิ่ม/ลบหลายอัน (เทียบกัน) • คลิกซ้ำที่อันเดิม = แสดงทั้งหมด</div><div class="chartbox scroll"><div class="chart-scroll-inner"><canvas id="c3"></canvas></div></div><div class="tbl-wrap"><div id="t3"></div></div></div>
</div></div>
<!-- PANEL 3: POINTS -->
